...
def mini_imagenet_folders():
    train_folder = '../../../data/miniImagenet/train' # 'trainval' or 'train'
    test_folder = '../../../data/miniImagenet/val' # 'test' or 'val'
...
class MiniImagenet(FewShotDataset):
    ...
    def __getitem__(self, idx):
        ...
        saliency_root = "../../../data/saliency/miniImagenet/" + image_name + '.png'
        ...
        return image, saliency_map, label
