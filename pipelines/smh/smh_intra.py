...
# Hyper Parameters
METHOD = "smh_intra_beta" + str(args.beta)
...
def main():
    ...
    for episode in range(EPISODE):   
        ...
        s_mix_feat = mixture_network((args.gamma*s_fore_feat + (1-args.gamma)*s_back_feat).view(CLASS_NUM*(SUPPORT_NUM_PER_CLASS**2),64,19,19)).view(-1,64,19**2)
        ...
        if np.mod(episode,2500)==0:
        	...
        	# save networks
                ...
                torch.save(checkpoint_best, "checkpoints/" + METHOD + "/chechpoint_" + str(SHOT) + "best.pth.tar")
